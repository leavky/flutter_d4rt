    ...
    constructors: {
      '': (visitor, positionalArgs, namedArgs) {
        return PointerDownEvent(
          ...
          pressureMin: namedArgs.get<double>('pressureMin') ?? 0.0,
          pressureMax: namedArgs.get<double>('pressureMax') ?? 1.0,
          distanceMax: namedArgs.get<double>('distanceMax') ?? 0.0,
          radiusMin: namedArgs.get<double>('radiusMin') ?? 0.0,
          radiusMax: namedArgs.get<double>('radiusMax') ?? 0.0,
        );
      },
    },
    getters: {
